...
export const Pagination = (props) => {
    ...
    return (
        <div style={mainStyles}>
            ...
            {
                number > 0 ? (
                    <div onClick={() => onPrevious()} style={spanStyles} className="btn-paginate">
                        <GrFormPreviousLink size="1.3rem" />
                    </div>
                ) : undefined
            }
            {
            ...
            {
                number !== max - 1 ? (
                    <div onClick={() => onNext()} style={spanStyles} className="btn-paginate">
                        <GrFormNextLink size="1.3rem" />
                    </div>
                ) : undefined
            }
            {
